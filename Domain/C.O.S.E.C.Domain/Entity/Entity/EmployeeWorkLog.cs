...
namespace C.O.S.E.C.Domain.Entity
{
    ...
    /// 工作日志
    /// </summary>
    public class EmployeeWorkLog : BaseEntityModel, IEntity<EmployeeWorkLog>
    {
        /// <summary>
        /// 主键ID
        /// </summary>
        ...
        /// <returns></returns>
        public EmployeeWorkLog Create(IEntityBaseAutoSetter setter)
        {
        ...
        /// <param name="setter"></param>
        /// <returns></returns>
        public EmployeeWorkLog Modify(Guid keyValue, IEntityBaseAutoSetter setter)
        {
            ID = keyValue;
