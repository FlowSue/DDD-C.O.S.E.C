...
using C.O.S.E.C.Infrastructure.Treasury.Interfaces;
using SqlSugar;
using System;
...
namespace C.O.S.E.C.Infrastructure.Treasury.Models
{
    public class DbContext<T> where T : class, IEntity<T>, new()
    {
        ...
        public DbContext(AllConfigModel _allConfigModel, IEntityBaseAutoSetter _setter)
        {
            ...
            {
                //ConnectionString = "Data Source=116.62.56.157;Initial Catalog=CosecCRM;Persist Security Info=True;User ID=sa;Password=lyrc@1209",
