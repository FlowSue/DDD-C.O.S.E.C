...
namespace C.O.S.E.C
{
    ...
    public class ExceptionEx : Exception
    {
        ...
        public static ExceptionEx ThrowBusinessException(Exception e, string msg = StringEx.str_empty)
        {
        ...
        /// <returns></returns>
        public static ExceptionEx ThrowServiceException(Exception e, string msg = StringEx.str_empty)
        {
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        public static ExceptionEx ThrowDataAccessException(Exception e, string msg = StringEx.str_empty)
        {
        ...
        /// <param name="msg"> 自定义异常消息 </param>
        /// <param name="e"> 实际引发异常的异常实例 </param>
        public static ExceptionEx ThrowComponentException(Exception e, string msg = StringEx.str_empty)
        {
