namespace C.O.S.E.C
{
    ...
    public static partial class Extensions
    {
        ...
        public static string Format(this int number, string defaultValue = StringEx.str_empty)
        {
            if (number == 0)
                return defaultValue;
        ...
        /// <param name="number">数值</param>
        /// <param name="defaultValue">空值显示的默认文本</param>
        public static string Format(this decimal number, string defaultValue = StringEx.str_empty)
        {
            if (number == 0)
                return defaultValue;
        ...
        /// <param name="number">数值</param>
        /// <param name="defaultValue">空值显示的默认文本</param>
        public static string Format(this double number, string defaultValue = StringEx.str_empty)
        {
            if (number == 0)
                return defaultValue;
            return string.Format("{0:0.##}", number);
